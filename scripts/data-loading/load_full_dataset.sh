...
load_csv_data "eurostyle_hr" "employee_training" "$CSV_DIR/eurostyle_hr.employee_training.csv.gz" || echo "⚠️  employee_training not generated, skipping..."
...
# Load all additional webshop tables generated by Universal Data Generator V2
