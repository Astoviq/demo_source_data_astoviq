...
# Load ALL additional operational tables (previously marked as optional but they ARE generated!)
load_csv_data "eurostyle_operational" "order_lines" "$CSV_DIR/eurostyle_operational.order_lines.csv.gz" || echo "⚠️  order_lines not generated, skipping..."
load_csv_data "eurostyle_operational" "inventory" "$CSV_DIR/eurostyle_operational.inventory.csv.gz" || echo "⚠️  inventory not generated, skipping..."
load_csv_data "eurostyle_operational" "european_geography" "$CSV_DIR/eurostyle_operational.european_geography.csv.gz" || echo "⚠️  european_geography not generated, skipping..."
load_csv_data "eurostyle_operational" "fashion_calendar" "$CSV_DIR/eurostyle_operational.fashion_calendar.csv.gz" || echo "⚠️  fashion_calendar not generated, skipping..."
load_csv_data "eurostyle_operational" "campaigns" "$CSV_DIR/eurostyle_operational.campaigns.csv.gz" || echo "⚠️  campaigns not generated, skipping..."
...
# Load all additional finance tables generated by Universal Data Generator V2
load_csv_data "eurostyle_finance" "chart_of_accounts" "$CSV_DIR/eurostyle_finance.chart_of_accounts.csv.gz" || echo "⚠️  chart_of_accounts not generated, skipping..."
load_csv_data "eurostyle_finance" "currencies" "$CSV_DIR/eurostyle_finance.currencies.csv.gz" || echo "⚠️  currencies not generated, skipping..."
load_csv_data "eurostyle_finance" "entity_accounts" "$CSV_DIR/eurostyle_finance.entity_accounts.csv.gz" || echo "⚠️  entity_accounts not generated, skipping..."
load_csv_data "eurostyle_finance" "exchange_rates" "$CSV_DIR/eurostyle_finance.exchange_rates.csv.gz" || echo "⚠️  exchange_rates not generated, skipping..."
load_csv_data "eurostyle_finance" "cost_centers" "$CSV_DIR/eurostyle_finance.cost_centers.csv.gz" || echo "⚠️  cost_centers not generated, skipping..."
load_csv_data "eurostyle_finance" "fixed_assets" "$CSV_DIR/eurostyle_finance.fixed_assets.csv.gz" || echo "⚠️  fixed_assets not generated, skipping..."
load_csv_data "eurostyle_finance" "depreciation_schedule" "$CSV_DIR/eurostyle_finance.depreciation_schedule.csv.gz" || echo "⚠️  depreciation_schedule not generated, skipping..."
load_csv_data "eurostyle_finance" "budget_data" "$CSV_DIR/eurostyle_finance.budget_data.csv.gz" || echo "⚠️  budget_data not generated, skipping..."
load_csv_data "eurostyle_finance" "budget_versions" "$CSV_DIR/eurostyle_finance.budget_versions.csv.gz" || echo "⚠️  budget_versions not generated, skipping..."
load_csv_data "eurostyle_finance" "entity_relationships" "$CSV_DIR/eurostyle_finance.entity_relationships.csv.gz" || echo "⚠️  entity_relationships not generated, skipping..."
load_csv_data "eurostyle_finance" "reporting_periods" "$CSV_DIR/eurostyle_finance.reporting_periods.csv.gz" || echo "⚠️  reporting_periods not generated, skipping..."
...
# Load all additional HR tables generated by Universal Data Generator V2
load_csv_data "eurostyle_hr" "departments" "$CSV_DIR/eurostyle_hr.departments.csv.gz" || echo "⚠️  departments not generated, skipping..."
load_csv_data "eurostyle_hr" "job_positions" "$CSV_DIR/eurostyle_hr.job_positions.csv.gz" || echo "⚠️  job_positions not generated, skipping..."
load_csv_data "eurostyle_hr" "employment_contracts" "$CSV_DIR/eurostyle_hr.employment_contracts.csv.gz" || echo "⚠️  employment_contracts not generated, skipping..."
load_csv_data "eurostyle_hr" "compensation_history" "$CSV_DIR/eurostyle_hr.compensation_history.csv.gz" || echo "⚠️  compensation_history not generated, skipping..."
load_csv_data "eurostyle_hr" "leave_balances" "$CSV_DIR/eurostyle_hr.leave_balances.csv.gz" || echo "⚠️  leave_balances not generated, skipping..."
load_csv_data "eurostyle_hr" "leave_requests" "$CSV_DIR/eurostyle_hr.leave_requests.csv.gz" || echo "⚠️  leave_requests not generated, skipping..."
load_csv_data "eurostyle_hr" "training_programs" "$CSV_DIR/eurostyle_hr.training_programs.csv.gz" || echo "⚠️  training_programs not generated, skipping..."
load_csv_data "eurostyle_hr" "employee_training" "$CSV_DIR/eurostyle_hr.employee_training_records.csv.gz" || echo "⚠️  employee_training_records not generated, skipping..."
load_csv_data "eurostyle_hr" "performance_cycles" "$CSV_DIR/eurostyle_hr.performance_cycles.csv.gz" || echo "⚠️  performance_cycles not generated, skipping..."
load_csv_data "eurostyle_hr" "performance_reviews" "$CSV_DIR/eurostyle_hr.performance_reviews.csv.gz" || echo "⚠️  performance_reviews not generated, skipping..."
load_csv_data "eurostyle_hr" "employee_surveys" "$CSV_DIR/eurostyle_hr.employee_surveys.csv.gz" || echo "⚠️  employee_surveys not generated, skipping..."
load_csv_data "eurostyle_hr" "survey_responses" "$CSV_DIR/eurostyle_hr.survey_responses.csv.gz" || echo "⚠️  survey_responses not generated, skipping..."
...
# Load ALL additional webshop tables (previously marked as optional but page_views IS generated!)
load_csv_data "eurostyle_webshop" "page_views" "$CSV_DIR/eurostyle_webshop.page_views.csv.gz" || echo "⚠️  page_views not generated, skipping..."
# Load all other additional webshop tables generated by Universal Data Generator V2
load_csv_data "eurostyle_webshop" "cart_analytics" "$CSV_DIR/eurostyle_webshop.cart_analytics.csv.gz" || echo "⚠️  cart_analytics not generated, skipping..."
load_csv_data "eurostyle_webshop" "marketing_campaigns" "$CSV_DIR/eurostyle_webshop.marketing_campaigns.csv.gz" || echo "⚠️  marketing_campaigns not generated, skipping..."
load_csv_data "eurostyle_webshop" "web_analytics_events" "$CSV_DIR/eurostyle_webshop.web_analytics_events.csv.gz" || echo "⚠️  web_analytics_events not generated, skipping..."
load_csv_data "eurostyle_webshop" "product_reviews" "$CSV_DIR/eurostyle_webshop.product_reviews.csv.gz" || echo "⚠️  product_reviews not generated, skipping..."
load_csv_data "eurostyle_webshop" "product_recommendations" "$CSV_DIR/eurostyle_webshop.product_recommendations.csv.gz" || echo "⚠️  product_recommendations not generated, skipping..."
load_csv_data "eurostyle_webshop" "wishlist_items" "$CSV_DIR/eurostyle_webshop.wishlist_items.csv.gz" || echo "⚠️  wishlist_items not generated, skipping..."
load_csv_data "eurostyle_webshop" "cart_activities" "$CSV_DIR/eurostyle_webshop.cart_activities.csv.gz" || echo "⚠️  cart_activities not generated, skipping..."
load_csv_data "eurostyle_webshop" "search_queries" "$CSV_DIR/eurostyle_webshop.search_queries.csv.gz" || echo "⚠️  search_queries not generated, skipping..."
load_csv_data "eurostyle_webshop" "email_marketing" "$CSV_DIR/eurostyle_webshop.email_marketing.csv.gz" || echo "⚠️  email_marketing not generated, skipping..."
load_csv_data "eurostyle_webshop" "ab_test_results" "$CSV_DIR/eurostyle_webshop.ab_test_results.csv.gz" || echo "⚠️  ab_test_results not generated, skipping..."
